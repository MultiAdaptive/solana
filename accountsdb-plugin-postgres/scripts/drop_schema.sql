...
DROP TRIGGER audit_account_update_trigger ON account;
DROP FUNCTION audit_account_update;
DROP TABLE account_audit;
DROP TRIGGER inspect_account_update_trigger ON account;
DROP FUNCTION inspect_account_update;
DROP TABLE account_inspect;
