...
//
// use crate::common::node_act::NodeAct;
// use crate::common::node_configs::{ExecuteChainConfiguration, SettleChainConfiguration, SettlePreparationConfiguration, StoreConfiguration};
...
//     }
//
//     pub fn act(mut self, node_act: &NodeAct) -> Self {
//         self.node_act = Some(node_act.clone());
//         self
//     }
//
//     pub fn slot(mut self, current_slot: u64) -> Self {
//         self.current_slot = Some(current_slot);
//         self
//     }
//
//     pub fn tx_no(mut self, current_tx_no: u32) -> Self {
//         self.current_tx_no = Some(current_tx_no);
//         self
//     }
//
//
